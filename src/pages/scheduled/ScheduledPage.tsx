    ...
    <div className="animate-bub-fade">
      ...
      {isError ? (
        ...
        <EmptyState
          ...
          action={
            <Link to="/scheduled/new" className="px-5 py-2.5 rounded-lg text-sm font-medium" style={{ backgroundColor: '#0F2A47', color: 'var(--c-on-brand)', fontFamily: 'Geist, sans-serif' }}>
              {t.newScheduled}
            </Link>
          }
        />
          ...
          {items.map(item => (
            ...
            >
              ...
              <div
                ...
                style={{ backgroundColor: FREQ_COLORS[item.frequency] || 'var(--c-text-muted)', minHeight: '40px' }}
              />
              ...
              <div className="text-right flex-shrink-0">
                <p className="text-base font-semibold" style={{ color: 'var(--c-text)', fontFamily: '"Geist Mono", monospace' }}>
