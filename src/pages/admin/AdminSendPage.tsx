      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="rounded-xl border p-5" style={{ backgroundColor: 'var(--c-surface)', borderColor: 'var(--c-border)' }}>
            <p className="text-xs font-semibold mb-4" style={{ color: 'var(--c-text-muted)', fontFamily: '"Geist Mono", monospace' }}>
              NOTIFICATION PREVIEW
            </p>
            <div className="rounded-xl border p-4" style={{ backgroundColor: 'var(--c-bg)', borderColor: 'var(--c-border)' }}>
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--c-border)' }}>
                ...
                <div>
                  <p className="text-sm font-semibold mb-1" style={{ color: 'var(--c-text)', fontFamily: 'Geist, sans-serif' }}>
                  ...
                  <p className="text-[10px] mt-2" style={{ color: 'var(--c-text-muted)', fontFamily: '"Geist Mono", monospace' }}>
                    Just now · IN_APP
                  </p>
                </div>
              </div>
